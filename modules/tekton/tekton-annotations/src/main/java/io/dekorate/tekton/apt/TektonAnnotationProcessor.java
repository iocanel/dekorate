...
public class TektonAnnotationProcessor extends AbstractAnnotationProcessor  {
  ...
  public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
    ...
    for (Element mainClass : mainClasses) {
      TektonApplication tektonApplication = mainClass.getAnnotation(TektonApplication.class);
      getSession().addAnnotationConfiguration(Maps.fromAnnotation("tekton", tektonApplication, TektonApplication.class));
    }
    return false;
  }
}
