...
public class AddAwsElasticBlockStoreVolumeToRevisionDecorator extends NamedResourceDecorator<RevisionSpecFluent<?>> {
  ...
  public AddAwsElasticBlockStoreVolumeToRevisionDecorator(AwsElasticBlockStoreVolume volume) {
    this(ANY, volume);
  }

  public AddAwsElasticBlockStoreVolumeToRevisionDecorator(String name, AwsElasticBlockStoreVolume volume) {
    super(name);
    this.volume = volume;
  }
